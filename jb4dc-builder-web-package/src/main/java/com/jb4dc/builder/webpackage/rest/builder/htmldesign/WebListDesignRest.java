...
@RestController
@RequestMapping(value = "/Rest/Builder/HtmlDesign/WebListDesign")
public class WebListDesignRest {
    ...
    public JBuild4DCResponseVo getPluginsConfig() throws JBuild4DCGenerallyException, JAXBException, ParserConfigurationException, SAXException, XPathExpressionException, IOException {
        JBuild4DCResponseVo responseVo=JBuild4DCResponseVo.success("获取插件定义成功!",ckEditorPluginsService.getListControlVoList());
