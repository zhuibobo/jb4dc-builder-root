...
Vue.component("inner-form-button-list-comp", {
  ...
  methods: {
    ...
    getTableFieldsAndBindToTable: function getTableFieldsAndBindToTable(oldData) {
      var _self = this;
