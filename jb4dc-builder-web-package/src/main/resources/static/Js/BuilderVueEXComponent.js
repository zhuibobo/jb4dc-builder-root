...
Vue.component("site-template-relation-comp", {
  ...
  methods: {
    ...
    init: function init() {
      ...
      var myDiagram = $(go.Diagram, "divSiteTemplateRelationWrap", {
      ...
      myDiagram.nodeTemplate.selectionAdornmentTemplate = $(go.Adornment, "Spot", $(go.Panel, "Auto", $(go.Shape, "RoundedRectangle", roundedRectangleParams, {
        fill: null,
        stroke: "#7986cb",
        strokeWidth: 3
