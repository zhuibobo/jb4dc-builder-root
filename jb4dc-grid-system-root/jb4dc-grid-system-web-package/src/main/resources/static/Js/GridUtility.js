...
var EChartsUtility = {
  ...
  BuildNormalPieOption: function BuildNormalPieOption(dataList, seriesName, title) {
    var legendConfig = {
      orient: 'vertical',
      left: 'left',
      data: []
