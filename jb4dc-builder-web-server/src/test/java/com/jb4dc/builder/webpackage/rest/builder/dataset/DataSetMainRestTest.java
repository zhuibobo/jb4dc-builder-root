...
public class DataSetMainRestTest extends DataSetSQLDesignerRestTest {
    ...
    public void addSQLDataSet() throws Exception {
        createDataSet("select TDEV_TEST_1.*,TDEV_TEST_2.F_TABLE1_ID,'ADDRESS' ADDRESS,'SEX' SEX from TDEV_TEST_1 join TDEV_TEST_2 on TDEV_TEST_1.ID=TDEV_TEST_2.F_TABLE1_ID where TDEV_TEST_1.ID='#{EnvVar.当前用户所在组织ID}'",
