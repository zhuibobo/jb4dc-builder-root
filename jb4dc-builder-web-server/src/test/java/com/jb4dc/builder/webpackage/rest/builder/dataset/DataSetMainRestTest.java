...
public class DataSetMainRestTest extends DataSetSQLDesignerRestTest {
    ...
    public void addSQLDataSet() throws Exception {
        ...
        createDataSet("select TDEV_TEST_3.*,TDEV_TEST_4.F_TABLE3_ID,'ADDRESS' ADDRESS,'SEX' SEX from TDEV_TEST_3 join TDEV_TEST_4 on TDEV_TEST_3.ID=TDEV_TEST_4.F_TABLE3_ID order by F_ORDER_NUM",
