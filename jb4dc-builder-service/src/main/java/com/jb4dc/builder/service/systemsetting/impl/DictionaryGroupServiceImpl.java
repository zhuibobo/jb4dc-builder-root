...
import com.jb4dc.builder.dao.systemsetting.DictionaryGroupMapper;
 ...
 */
@Service
public class DictionaryGroupServiceImpl extends BaseServiceImpl<DictionaryGroupEntity> implements com.jb4dc.builder.service.systemsetting.IDictionaryGroupService {
    ...
    @Override
    public void initSystemData(JB4DCSession JB4DCSession, com.jb4dc.builder.service.systemsetting.IDictionaryService dictionaryService) throws JBuild4DCGenerallyException {
        //根字典分组
