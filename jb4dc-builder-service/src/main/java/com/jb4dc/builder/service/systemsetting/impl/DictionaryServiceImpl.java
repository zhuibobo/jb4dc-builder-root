...
import com.jb4dc.builder.dao.systemsetting.DictionaryMapper;
...
public class DictionaryServiceImpl extends BaseServiceImpl<DictionaryEntity> implements IDictionaryService {
    ...
    @Override
    public List<DictionaryEntity> getEnableListDataByGroupValue(JB4DCSession session, String groupValue) {
        return dictionaryMapper.selectEnableListByGroupValue(groupValue);
    }
