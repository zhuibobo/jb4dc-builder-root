package com.jb4dc.builder.workflow.exenum;
...
public enum ModelTenantIdEnum  implements BaseEnum<EnableTypeEnum, Integer> {
    builderGeneralTenant(1,"BuilderGeneralTenant");
    ...
    private ModelTenantIdEnum(int value,String displayName) {
        this.value=value;
