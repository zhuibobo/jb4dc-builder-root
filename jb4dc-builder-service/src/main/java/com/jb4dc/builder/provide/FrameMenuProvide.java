package com.jb4dc.builder.provide;
...
public class FrameMenuProvide implements IFramePageProvide {
    ...
    public FrameMenuProvide(MenuRuntimeRemote menuRuntimeRemote,AppRuntimeRemote appRuntimeRemote,JBuild4DCYaml _jBuild4DCYaml){
        this.menuRuntimeRemote=menuRuntimeRemote;
    ...
    public List<MenuPO> getMyFrameMenu(JB4DCSession jb4DCSession) throws JBuild4DCGenerallyException {
        List<MenuPO> menuPOList =  menuRuntimeRemote.getMyAuthMenusBySystemIdRT(jb4DCSession.getUserId(),"BuilderMainApp").getData();
        return menuPOList;
    }
