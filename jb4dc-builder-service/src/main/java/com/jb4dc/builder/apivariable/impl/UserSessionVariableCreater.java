...
public class UserSessionVariableCreater implements IAPIVariableCreater {
    ...
    public String createVar(JB4DCSession jb4DSession, EnvVariableVo vo) throws JBuild4DCGenerallyException {
        ...
        throw new JBuild4DCGenerallyException(JBuild4DCGenerallyException.EXCEPTION_BUILDER_CODE,"UserSessionVariableCreater.createVar中无法根据"+vo.getPara()+"查询到对应的数据！");
    }
}
