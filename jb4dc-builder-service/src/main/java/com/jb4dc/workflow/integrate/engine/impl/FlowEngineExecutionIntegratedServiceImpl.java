...
@Service
public class FlowEngineExecutionIntegratedServiceImpl implements IFlowEngineExecutionIntegratedService {
    ...
    @Override
    public int multiCountEngInstances(JB4DCSession jb4DCSession, String executionId){
        ProcessEngine processEngine=CamundaIntegrate.getProcessEngine();
        Object nrOfInstances = processEngine.getRuntimeService().getVariable(executionId, "nrOfInstances");
