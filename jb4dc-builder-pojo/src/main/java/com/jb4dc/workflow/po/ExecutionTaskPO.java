...
public class ExecutionTaskPO extends ExecutionTaskEntity {
    ...
    public ExecutionTaskPO(
            String extaskId, String extaskInstId, String extaskModelId, String extaskRuTaskId, String extaskRuExecutionId, String extaskRuProcInstId,
        ...
        super(   extaskId,  extaskInstId,  extaskModelId,  extaskRuTaskId,  extaskRuExecutionId,  extaskRuProcInstId,
                 extaskRuProcDefId,  extaskPreNodeKey,  extaskPreNodeName,  extaskCurNodeKey,  extaskCurNodeName,  extaskType,
                 extaskStatus,  extaskSenderId,  extaskSenderName,  extaskSendTime,  extaskReceiverId,  extaskReceiverName,
