...
var WLDCT_ListTableContainer = {
  ...
  CreateTable: function CreateTable($singleControlElem, dataSet) {
  ...
  CheckedRow: function CheckedRow(id) {
  ...
  UnCheckedRow: function UnCheckedRow(id) {
