...
var WFDCT_SubFormListContainer = {
  ...
  CreateIdFieldInOneDataRecord: function CreateIdFieldInOneDataRecord(oneDataRecord) {
  ...
  FindIdFieldByOneDataRecord: function FindIdFieldByOneDataRecord(oneDataRecord) {
    return ArrayUtility.WhereSingle(oneDataRecord, function (item) {
      return item.fieldName == "ID";
    });
  },
  UpdateRow: function UpdateRow(oneDataRecord, $pageTr) {
  ...
  _$LastEditRow: null,
  InnerRow_Add: function InnerRow_Add(sender, $hostElem, _rendererChainParas) {
    var $tr = this._$TemplateTableRow.clone();
