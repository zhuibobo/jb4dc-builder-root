...
var FormRelationPOUtility = {
  ...
  GetRelationPOById: function GetRelationPOById(relationPOList, id) {
    return ArrayUtility.WhereSingle(relationPOList, function (po) {
      return po.id == id;
    });
  },
  GetRelationPOByTableName: function GetRelationPOByTableName(relationPOList, tableName) {
    return ArrayUtility.WhereSingle(relationPOList, function (po) {
      return po.tableName == tableName;
    });
  },
  GetRelationPOBySingleName: function GetRelationPOBySingleName(relationPOList, singleName) {
    return ArrayUtility.WhereSingle(relationPOList, function (po) {
...
var WFDCT_SubFormListContainer = {
  ...
  Dialog_ShowAddRowSubFormDialog: function Dialog_ShowAddRowSubFormDialog(sender, $hostElem, _rendererChainParas, instanceName) {
  ...
  Dialog_CompletedEdit: function Dialog_CompletedEdit(instanceName, serializationSubFormData) {
    var thisInstance = HTMLControl.GetInstance(instanceName);
    this.Dialog_AddRowToContainer();
  },
  Dialog_AddRowToContainer: function Dialog_AddRowToContainer(oneDataRecord, childRelationPOArray) {
    if (oneDataRecord) {
      var $tr = this._$TemplateTableRow.clone();
