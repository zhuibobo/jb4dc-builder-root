...
var WFDCT_SubFormListContainer = {
  ...
  InnerRow_AddEventEdit: function InnerRow_AddEventEdit(sender, $hostElem, _rendererChainParas) {
    var $tr = this._$TemplateTableRow.clone();

    this._$TableBodyElem.append($tr);
  },
  Dialog_AddEventNew: function Dialog_AddEventNew(sender, $hostElem, _rendererChainParas, instanceName) {
