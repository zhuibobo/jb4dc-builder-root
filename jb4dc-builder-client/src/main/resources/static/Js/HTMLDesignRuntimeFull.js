...
var WLDCT_ListTableContainer = {
  ...
  RendererSingleRow: function RendererSingleRow($templateTableRow, dataSet, rowData) {
  ...
  RendererSingleCell: function RendererSingleCell($templateTableRow, dataSet, rowData, $row, $td, value) {
