...
var WFDCT_SubFormListContainer = {
  ...
  Dialog_Get_SubForm_RecordComplexPo: function Dialog_Get_SubForm_RecordComplexPo(instanceName, subFormDataRelationList) {
    var thisInstance = HTMLControl.GetInstance(instanceName);
