...
var WFDCT_SubFormListContainer = _defineProperty({
  ...
  _$LastEditRow: null,
  InnerRow_Add: function InnerRow_Add(oneDataRecord) {
    this.InnerRow_CompletedLastEdit();
