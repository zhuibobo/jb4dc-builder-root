...
var WFDCT_SubFormListContainer = {
  ...
  AddEventNewDialog: function AddEventNewDialog(sender, $hostElem, _rendererChainParas, instanceName) {
  ...
  CompletedNewDialogEdit: function CompletedNewDialogEdit(instanceName, operationType, serializationSubFormData) {
  ...
  AddEventInnerRowEdit: function AddEventInnerRowEdit(sender, $hostElem, _rendererChainParas) {},
  ...
  NewRow: function NewRow(oneDataRecord) {
