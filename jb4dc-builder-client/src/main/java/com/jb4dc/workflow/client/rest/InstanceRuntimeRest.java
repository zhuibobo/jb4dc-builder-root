...
public class InstanceRuntimeRest {
    ...
    public JBuild4DCResponseVo<PageInfo<ExecutionTaskPO>> getMyProcessTaskList(int pageNum, int pageSize, String modelCategory, String extaskType) throws JBuild4DCGenerallyException {
    ...
    @RequestMapping(value = "/GetMyProcessTaskList", method = {RequestMethod.GET, RequestMethod.POST})
    public JBuild4DCResponseVo<PageInfo<ExecutionTaskPO>> getMyProcessTaskList(@RequestBody ExecutionTaskSearchModel executionTaskSearchModel) throws JBuild4DCGenerallyException {
        return workFlowInstanceRuntimeService.getMyProcessTaskList(JB4DCSessionUtility.getSession(), executionTaskSearchModel);
    }

    @RequestMapping(value = "/GetMyProcessEndTaskList", method = {RequestMethod.GET, RequestMethod.POST})
    ...
    @RequestMapping(value = "/GetMyInstanceCompletedList", method = {RequestMethod.GET, RequestMethod.POST})
