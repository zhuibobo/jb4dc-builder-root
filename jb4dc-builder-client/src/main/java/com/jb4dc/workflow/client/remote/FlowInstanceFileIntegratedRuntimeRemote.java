...
public interface FlowInstanceFileIntegratedRuntimeRemote {
    ...
    JBuild4DCResponseVo<String> addInstanceFile(@RequestBody InstanceFileEntity instanceFileEntity);

    @RequestMapping(value = "/GetAttachmentFileListData",method = RequestMethod.GET)
    JBuild4DCResponseVo<List<InstanceFileEntity>> getAttachmentFileListData(@RequestParam("userId") String userId,@RequestParam("organId") String organId,@RequestParam("instanceId") String instanceId);
}
