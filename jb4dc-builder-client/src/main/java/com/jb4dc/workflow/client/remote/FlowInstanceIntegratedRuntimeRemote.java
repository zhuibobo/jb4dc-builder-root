...
public interface FlowInstanceIntegratedRuntimeRemote {
    ...
    JBuild4DCResponseVo<ResolveNextPossibleFlowNodePO> resolveNextPossibleFlowNode(@RequestBody RequestResolveNextPossibleFlowNodePO resolveNextPossibleFlowNodePO);
