...
public interface FlowInstanceIntegratedRuntimeRemote {
    ...
    @PostMapping(value = "/ResolveNextPossibleUseTaskWithStartNode",consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    JBuild4DCResponseVo<List<BpmnTask>> resolveNextPossibleUseTaskWithStartNode(Map<String, ?> formParams);
