...
@FeignClient(name= "${jb4dc.builder.server.name}",contextId = "ListRuntimeRemote",configuration = { BuilderClientFeignClientConfig.class },path = "${jb4dc.builder.server.context-path}/Rest/Builder/RunTime/ListRuntime")
